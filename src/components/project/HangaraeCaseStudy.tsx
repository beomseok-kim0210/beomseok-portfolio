...
function TroubleSignalPanel({ trouble }: { trouble: HangaraeTrouble }) {
  ...
  return (
    <div className="rounded-[32px] border border-[#E2E8F0] bg-white p-6 md:p-8">
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
        <div className="rounded-[28px] bg-[#F8FAFC] p-6 md:p-8">
          <p className="small-label text-[#22C55E]">Signal Translation</p>
          <p className="mt-4 text-[34px] font-semibold leading-[1.06] tracking-[-0.04em] text-[#111827] md:text-[42px]">
            {trouble.metricTitle}
          </p>
        ...
        <div className="grid gap-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-[28px] border border-[#E2E8F0] bg-white p-6">
              ...
              <p className="mt-4 text-[40px] font-semibold leading-none tracking-[-0.05em] text-[#111827]">
                {stages.length}
              </p>
              <p className="project-caption mt-2">stages in this flow</p>
            </div>
            <div className="rounded-[28px] border border-[#E2E8F0] bg-white p-6">
              ...
              <p className="project-caption mt-2">implementation surfaces</p>
            </div>
          </div>
          <div className="rounded-[28px] bg-[#F8FAFC] p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2.5">
              {trouble.tech.map((item) => (
                <span
                  key={item}
                  className="rounded-full border border-[#DCE5EF] bg-white px-4 py-2.5 text-base font-semibold text-slate-700"
                >
                  {item}
                </span>
              ))}
