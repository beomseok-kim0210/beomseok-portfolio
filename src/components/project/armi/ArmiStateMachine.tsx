        ...
        <MotionBlock className="mt-14">
          <div className="rounded-[40px] border border-[#E2E8F0] bg-[#F8FAFC] p-6 md:p-10">
                ...
                >
                  ...
                  <div className="mt-8 flex flex-1 flex-col justify-center">
                    {group.nodes.map((node, index) => (
                      <div key={node}>
                        <div className="rounded-full border border-slate-200 bg-[#F8FAFC] px-5 py-4 text-center text-[26px] font-semibold leading-[1.35] text-[#111827]">
                          {node}
                        </div>
                        {index < group.nodes.length - 1 ? (
                          <div className="py-3 text-center text-[30px] font-semibold text-slate-300">
                            ↓
                          </div>
                        ) : null}
                      </div>
                  ...
                  <p className="project-caption mt-8 border-t border-slate-200 pt-5 font-semibold text-slate-700">
                    {group.rule}
                  </p>
                </article>
              ))}
            ...
            <div className="mt-10 rounded-[28px] bg-white p-6">
              ...
              <p className="project-body mt-4 text-slate-700">
                핵심 상태 전환 기준은 기능 완료가 아니라 마이크를 누가 소유하고 있는가였습니다.
              </p>
            </div>
          </div>
        </MotionBlock>
